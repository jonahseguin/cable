...
const procedureBuilder = implement(api).context<{ readonly identity: { readonly role: "admin" | "member" } | null }>();
...
export const protectedPerfProcedure = protectedProcedure(api.group0.section0.procedure0, ({ ctx, input }) => ({
