...
export { ConnectionState, [removed]ConnectionManager } from './lib/connection';
...
/**
 * Creates a [removed] client instance with connection-aware channel functionality.
 *
