...
import { Sock8ConnectionManager, ConnectionState, type ConnectionConfig } from './connection.js';
...
describe('Sock8ConnectionManager', () => {
  ...
  it('should initialize in disconnected state', () => {
    const config: ConnectionConfig = {
      authEndpoint: 'https://api.example.com/sock8/connect',
    };
  ...
  it('should authenticate and establish websocket connection when connect is called', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://api.example.com/sock8/connect',
