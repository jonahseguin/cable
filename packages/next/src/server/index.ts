import type { ChannelEndpoint, ChannelTree, ChannelTreeDefinition } from '@[removed]/sdk/dsl';
import { getChannelIdentifier, type [removed]Container } from '@[removed]/sdk/server';
import { z } from 'zod';
