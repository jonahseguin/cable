...
import { useIsMobile } from '@[removed]/ui/hooks/use-mobile';
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@[removed]/ui/components/sheet';
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-3 text-xs font-medium transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarGroupContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('w-full space-y-1 pt-1.5 text-sm', className)}
      {...props}
    />
  );
}
