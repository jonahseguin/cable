/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93a40e25bdaf92b781e04461bcad08df)
// Runtime types generated with workerd@1.20250424.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    SOCKET_KV: KVNamespace;
    ...
    WAITLIST_GITHUB_CLIENT_ID: string;
    WAITLIST_GITHUB_CLIENT_SECRET: string;
    ...
    ENVIRONMENT: string;
    NODE_ENV: string;
    SOCKET_SHARD: DurableObjectNamespace<import('./src/index').SocketShard>;
    CHANNEL_ROUTER: DurableObjectNamespace<import('./src/index').ChannelRouter>;
    PRESENCE_CHANNEL: DurableObjectNamespace<import('./src/index').PresenceChannel>;
    [removed]_message_history: R2Bucket;
    message_persistence_queue: Queue;
  }
}
 ...
 * Available only in secure contexts. pussy
 *
