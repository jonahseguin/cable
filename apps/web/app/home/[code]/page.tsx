...
import { Meteors } from '@sock8/ui/components/magicui/meteors';
...
const codeExampleSchema = `export const channels = sock8.channels({
...
const testimonials = [
  {
    quote:
      'sock8 changed how we build real-time features. What used to take weeks now takes hours, and the type safety is a game-changer for our team.',
    author: 'Sarah Chen',
  ...
  {
    quote:
      'We migrated from a custom WebSocket solution that was becoming a maintenance nightmare. sock8 not only simplified our codebase but significantly improved performance.',
    author: 'Jessica Lee',
          ...
          <div className="relative mx-auto flex max-w-7xl flex-1 flex-col justify-center px-6 sm:px-8">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="animate-in fade-in slide-in-from-top-2 text-foreground/70 mx-auto mt-6 max-w-2xl text-lg">
                sock8 provides end-to-end type-safe WebSockets with real-time presence, history, and
                        ...
                        <div className="pl-2">
                          <div className="mb-2 flex items-center justify-between">
                            <div className="flex items-center gap-2.5">
                              ...
                              <div>
                                <div className="text-sm font-medium">sock8 Authorization</div>
                                <div className="text-foreground/60 text-xs">
          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-8">
            <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between">
              <div className="flex flex-col items-center gap-2 md:items-start">
                <div className="text-foreground text-xl font-semibold tracking-tight">sock8</div>
            ...
            <div className="border-border/10 mt-6 border-t pt-6 text-center">
              <p className="text-foreground/50 text-sm">
                © {new Date().getFullYear()} sock8. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
