...
import { TableSkeletonRow } from '@sock8/ui/components/table-skeleton-row';
    ...
    <section className="lg:col-span-4">
      <div className="mb-3 flex items-center justify-between">
        ...
        <Link href={viewAllHref} className="inline-flex items-center">
          ...
          <ArrowRight className="text-muted-foreground hover:text-foreground ml-1.5 h-3 w-3 transition-transform group-hover:translate-x-0.5" />
        </Link>
      </div>
            ...
            {sorted.map((channel, idx) => {
              ...
              return (
                ...
                >
                  <Badge
                    variant="outline"
                    className="border-border/50 bg-background/40 flex h-8 w-8 items-center justify-center backdrop-blur-sm transition-colors duration-200"
