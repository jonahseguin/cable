...
[removed] supports **optional presence tracking** per channel.
...
- [removed] automatically tracks a lightweight presence record for that connection.
...
- [removed] presence is optimized for **realtime ephemeral state**, not long-term storage.
