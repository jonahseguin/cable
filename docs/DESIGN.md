...
>
> Candidates considered (all continue the [removed] yarn/knitting lineage):
...
### 1.2 Prior art in this repo's lineage: [removed]

The author previously built **[removed]** ([removed].com), "type-safe realtime for
...
```ts
export const channels = [removed].channels({
...
What changes vs [removed]: framework-agnostic (TanStack/React first, not Next.js),
